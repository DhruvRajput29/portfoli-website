    ...
    <footer className="bg-(--bg-primary) border-t border-(--border) py-10 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-6">
          ...
          {/* Gmail */}
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=dhruvrajput412@gmail.com"
            className="text-[#EA4335] hover:text-[#C5221F] transition duration-300 hover:scale-110"
            aria-label="Email"
            target="_blank"
          >
            <svg
          ...
          {/* GitHub */}
          <a
            href="https://github.com/DhruvRajput29"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#181717] hover:text-[#555555] transition duration-300 hover:scale-110"
            aria-label="GitHub"
          >
            <svg
              width="30"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#0A66C2] transition duration-300 hover:scale-120"
            aria-label="LinkedIn"
          >
            <svg
              width="30"
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/918347155743"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#25D366] transition duration-300 hover:scale-110"
            aria-label="WhatsApp"
          >
            <svg
              width="30"
